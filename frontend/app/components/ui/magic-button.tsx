...
// make responsive to theme color

const MagicButton = ({children }: any) => {

  return (
        <button className="mt-4 w-full relative inline-flex h-12 overflow-hidden rounded-md p-[1px] focus:outline-none">
